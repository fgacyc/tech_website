        ...
        <div>
            {
                language === "zh"
                    ? <div className="bg-white rounded-lg  p-8  overflow-y-scroll">
                        ...
                        <div className="text-xl font-semibold mb-2">9. 适用法律</div>
                        <p className="mb-4">这些条款应依据马来西亚法律解释和构建，不考虑其法律冲突规定。</p>

                        <div className="text-xl font-semibold mb-2">10. 条款变更</div>
                        <p className="mb-4">我们保留在我们自己的全权决定权下随时修改或替换这些条款的权利。如果修订是重大的，我们将在任何新条款生效之前至少提供30天的通知。什么构成重大变化将由我们自行决定。</p>

                        <div className="text-xl font-semibold mb-2">11. 联系我们</div>
                    ...
                    : <div className="bg-white rounded-lg shadow-md p-8 h-screen overflow-y-scroll">
                        ...
                        <p className="mb-4">Welcome to FGA Tech Team (&quot;we,&quot; &quot;our,&quot; or &quot;us&quot;).
                            These Terms of Service
                            (&quot;Terms&quot;)
                            govern your use of our technology products and services (&quot;Services&quot;). By accessing or
                            using our
                            Services, you agree to be bound by these Terms. If you do not agree to these Terms, please do
                            not
                            use our Services.</p>

                        <div className="text-xl font-semibold mb-2">2. Eligibility</div>
                        ...
                        <div className="text-xl font-semibold mb-2">3. Use of Services</div>
                        ...
                        <div className="text-xl font-semibold mb-2">4. User Accounts</div>
                        ...
                        <div className="text-xl font-semibold mb-2">5. Prohibited Activities</div>
                        ...
                        <div className="text-xl font-semibold mb-2">6. Intellectual Property</div>
                        ...
                        <div className="text-xl font-semibold mb-2">7. Termination</div>
                        ...
                        <div className="text-xl font-semibold mb-2">8. Limitation of Liability</div>
                        ...
                        <div className="text-xl font-semibold mb-2">9. Governing Law</div>
                        ...
                        <div className="text-xl font-semibold mb-2">10. Changes to Terms</div>
                        ...
                        <div className="text-xl font-semibold mb-2">11. Contact Us</div>
