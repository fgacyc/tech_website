        ...
        <div>
            {
                language === "zh"
                    ? <div className="bg-white rounded-lg shadow-md p-8 overflow-y-scroll text-white">
                        ...
                        <div className="text-xl font-semibold mb-2">2. 我们收集的信息</div>
                        ...
                        <div className="text-xl font-semibold mb-2">3. 信息使用</div>
                        ...
                        <div className="text-xl font-semibold mb-2">4. 分享您的信息</div>
                        ...
                        <div className="text-xl font-semibold mb-2">5. 您的信息安全</div>
                        ...
                        <div className="text-xl font-semibold mb-2">6. 您的数据保护权利</div>
                        ...
                        <div className="text-xl font-semibold mb-2">7. 本隐私政策的变更</div>
                        <p className="mb-4">我们可能会不时更新我们的隐私政策。我们将通过在此页面上发布新的隐私政策来通知您任何更改。建议您定期查看本隐私政策以获取任何更改。本隐私政策的更改在发布在此页面时生效。</p>

                        <div className="text-xl font-semibold mb-2">8. 联系我们</div>
                    ...
                    : <div className="bg-white rounded-lg shadow-md p-8 overflow-y-scroll h-screen">
                        ...
                        <div className="text-xl font-semibold mb-2">2. Information We Collect</div>
                        ...
                        <div className="text-xl font-semibold mb-2">3. Use of Your Information</div>
                        ...
                        <div className="text-xl font-semibold mb-2">4. Sharing Your Information</div>
                        ...
                        <div className="text-xl font-semibold mb-2">5. Security of Your Information</div>
                        ...
                        <div className="text-xl font-semibold mb-2">6. Your Data Protection Rights</div>
                        ...
                        <div className="text-xl font-semibold mb-2">7. Changes to This Privacy Policy</div>
                        ...
                        <div className="text-xl font-semibold mb-2">8. Contact Us</div>
